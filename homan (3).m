...
figure
hold on
plot3(orbit1(1,:)*mtoau-0.2627, orbit1(2,:)*mtoau-0.94757, orbit1(3,:)*mtoau, 'b' ,'LineWidth', 1);
plot3(orbit2(1,:)*mtoau-0.2627, orbit2(2,:)*mtoau -0.94757, orbit2(3,:)*mtoau , 'b' ,'LineWidth', 1);
plot3(orbit3(1,:)*mtoau-0.2627, orbit3(2,:)*mtoau-0.94757, orbit3(3,:)*mtoau, 'b' ,'LineWidth', 1);
hold off
